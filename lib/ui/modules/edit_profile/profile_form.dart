...
class SaleItemForm extends StatefulWidget {
  ...
  const SaleItemForm({Key key,@required  this.scaffoldKey,@required  this.formKey,@required  this.onSave,@required  this.submit,@required  this.defaultData,@required this.status,@required this.setVideo, this.buttonText="Add", this.video}) : super(key: key);
  @override
